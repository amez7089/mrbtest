...
#买家登录到待收货页面确认收货
    ...
    if (OrderNumber3 == OrderNumber):
        ...
        time.sleep(3)
        #待确认收货成功，查看按钮是否变为评价
        ButtonStatus = driver.find_element_by_xpath("//*[@id='app']/div/div[2]/section[2]/div[2]/div[1]/div[1]/div/span[2]/a").text
...
#商家用户登录处理退款请求
    ...
    driver.find_element_by_xpath("//*[@id='main']/div[2]/ul/li[1]/div[2]/div[2]/div/textarea").send_keys(u"运输途中损坏商品，同意退款退货！")
    #提交
...
#卖家登录确认收取退件     
    ...
    if (OrderNumber5 == OrderNumber):
        ...
        driver.find_element_by_xpath("//*[@id='main']/div[2]/ul/li[1]/div[3]/div/div[2]/div/textarea").send_keys(u"确认--同意--已收货！")
        #提交
