...
print u"****Case--AmezMallUI_012_MerchantsIssueCoupons商家新增优惠券--开始运行****"
...
try:
    ...
    time.sleep(1)
    #在新增优惠券页面输入名称：
    CouponsName =  u"满2000减1000_" + str(datetime.now())
    print "CouponsName:",CouponsName
    ws.write(189,5,CouponsName)
    ...
    #消费金额为2000
    driver.find_element_by_xpath("//*[@id='main']/div[2]/div[2]/form/div[7]/div/div/input").send_keys("2000")
    time.sleep(1)
    #代金券描述：
    driver.find_element_by_xpath("//*[@id='main']/div[2]/div[2]/form/div[8]/div/div/textarea").send_keys(u"满2000减1000")
    time.sleep(1)
    #上传图片
    ...
    ws.write(199,5,CouponsName1)
    if (CouponsName == CouponsName1):
        print u"发布代金券成功！！"
        print (u"Case--AmezMallUI_012_MerchantsIssueCoupons商家新增优惠券---结果：Pass!")
        ws.write(183,7, 'Pass')
        #如果成功，将错误日志覆盖
        ws.write(183,10,'')
    else:
        print u"发布代金券失败！！"
        print (u"Case--AmezMallUI_012_MerchantsIssueCoupons商家新增优惠券---结果：Failed!")
        ws.write(183,7, 'Failed',style2)
        ws.write(183,10, u"发布代金券失败！！",style2)
    time.sleep(3)
    #回滚数据，将优惠券置为无效
    ...
    ws.write(183,10,errorInfo,style2)
    
finally :
    if(errorFlag == 0):
        print (u"Case--AmezMallUI_012_MerchantsIssueCoupons商家新增优惠券---结果：Failed!")
        ws.write(183,7, 'Failed',style2)
    ws.write(183,9, 'lilei')
