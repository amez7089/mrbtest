...
casefile = xlrd.open_workbook('E:\\gitworksqace\\mrbdome1\\test1\\amez_test\\InterfaceData.xls', formatting_info=True)
#设置日期格式
style1 = xlwt.XFStyle()
...
#           self.driver.quit() 
            ...
            wb.save('E:\\gitworksqace\\mrbdome1\\test1\\amez_test\\InterfaceData.xls')
            print("tearDown")  
