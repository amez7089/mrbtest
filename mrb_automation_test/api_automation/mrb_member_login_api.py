...
casefile = xlrd.open_workbook('E:\\gitworksqace\\mrbdome1\\test1\\mrb_automation_test\\api_automation\\mrb_api.xls', formatting_info=True)
# 设置日期格式
style1 = xlwt.XFStyle()
...
class MyTest(unittest.TestCase):
    ...
    def tearDown(self):
        ...
        wb.save('E:\\gitworksqace\\mrbdome1\\test1\\mrb_automation_test\\api_automation\\mrb_api.xls')
        print("tearDown")
